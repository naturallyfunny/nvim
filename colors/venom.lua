...
local c = {
    ...
    fg = "#FFFFFF",
    emph = "#FAFAFA",
    on_accent = "#000000", -- text drawn on top of a bright fill
    ...
    utype = "#cfd6f1",
    comment = "#31321D", -- deliberately near-invisible

    -- Neutral ladder, quiet → loud. Carries the chrome that no syntax role owns.
    gutter = "#404040",
    shade = "#4A4A4A",
    inactive = "#4a4a4a",
    grey = "#5c5c5c",
    ...
    -- mono and venom-light, so gaps stay put rather than being renumbered.
    bg0 = "#101010",
    bg1 = "#1a1a1a",
    bg2 = "#1c1c1c",
    bg3 = "#1e1e1e",
...
set_hl(g.module, { fg = c.module, italic = true })
...
vim.api.nvim_set_hl(0, "Question", { fg = c.fg }) -- "Save changes?" confirm prompt
...
set_hl({ "SnacksPickerPathHidden", "SnacksPickerGitStatusUntracked" }, { fg = c.soft })
...
vim.api.nvim_set_hl(0, "SnacksIndentScope", { fg = c.fg })
...
set_hl({ "DashboardDesc", "DashboardCenter", "SnacksDashboardDesc" }, { fg = c.soft })
set_hl({ "SnacksDashboardFile" }, { fg = c.clear })
set_hl({ "SnacksDashboardDir" }, { fg = c.soft })
set_hl({ "DashboardFooter", "SnacksDashboardFooter" }, { fg = c.faint })
...
vim.api.nvim_set_hl(0, "Visual", { bg = c.shade, fg = c.fg })
...
vim.api.nvim_set_hl(0, "Substitute", { bg = c.shade, fg = c.fg })
vim.api.nvim_set_hl(0, "WildMenu", { bg = c.shade, fg = c.fg })
vim.api.nvim_set_hl(0, "QuickFixLine", { bg = c.bg5, fg = c.fg })
vim.api.nvim_set_hl(0, "LspSignatureActiveParameter", { bg = c.shade, fg = c.fg, bold = true })
