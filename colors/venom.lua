...
local c = {
  ...
  ret = "#909090",    -- venom return keyword
  builtin = "#92b3f4",-- venom built-in functions/methods
  utype = "#bcc4e1",  -- venom custom/user-defined types (cool silver)
...
set_hl({
  "@function.builtin",
  "@lsp.typemod.function.defaultLibrary", "@lsp.typemod.method.defaultLibrary",
}, { fg = c.builtin })
