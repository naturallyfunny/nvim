...
local c = {
  ...
  sel     = "#35484e",
  const   = "#328c45",  -- constants, numbers
  op      = "#FFFFFF",  -- operators, punctuation
  comment = "#3c3f55",  -- dark ink, barely above bg
  module  = "#4a7040",  -- structural green: namespaces
...
vim.api.nvim_set_hl(0, "MiniIconsAzure",         { fg = c.fg })
...
set_hl({ "DashboardHeader", "SnacksDashboardHeader" },               { fg = c.const })
set_hl({ "DashboardIcon",   "SnacksDashboardIcon" },                 { fg = c.keyword })
